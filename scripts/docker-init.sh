#!/bin/sh
# Init script for Yandex Disk provider Docker dev environment.
# Auto-generated by ma-provider-tools — do not edit manually.
set -e

echo "==> Setting up Yandex Disk provider..."
...
rm -rf "${PROVIDERS_DIR}/filesystem_yandex_disk"
ln -s /tmp/provider "${PROVIDERS_DIR}/filesystem_yandex_disk"
echo "==> Provider linked: ${PROVIDERS_DIR}/filesystem_yandex_disk"
