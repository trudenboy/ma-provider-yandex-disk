...
- Авторизация как в Google Drive: своё OAuth-приложение Яндекса (`cloud_api:disk.read`), кнопка Authorize и авто-refresh токена. Работает на бесплатных аккаунтах.
