...
export default defineConfig({
	site: 'https://trudenboy.github.io/ma-provider-yandex-disk',
	base: '/ma-provider-yandex-disk',
	integrations: [
		starlight({
			title: 'Yandex Disk · MA Provider',
			locales: {
			...
			defaultLocale: 'root',
			editLink: {
				baseUrl: 'https://github.com/trudenboy/ma-provider-yandex-disk/edit/dev/docs-site/src/content/docs/',
			},
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/trudenboy/ma-provider-yandex-disk' },
			],
			sidebar: [
