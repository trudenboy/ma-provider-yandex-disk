...
# Yandex Disk — локальная разработка через Docker

Запусти полноценный Music Assistant с провайдером Yandex Disk одной командой —
...
## Подключение провайдера Yandex Disk

После входа:

1. Перейди в **Settings** → **Providers**
2. Найди **Yandex Disk** в списке — он уже доступен, код загружен автоматически
