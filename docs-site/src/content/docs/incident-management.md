...
# Yandex Disk — Управление инцидентами

## Куда заводить инциденты

> **Заводи задачи здесь:** [github.com/trudenboy/ma-provider-yandex-disk/issues](https://github.com/trudenboy/ma-provider-yandex-disk/issues)
...
- **Поле Provider**: устанавливается автоматически для Yandex Disk
